...
<template>
  <div>
    ...
    >
      ...
      <div class="text-purple-950 text-4xl font-medium leading-9">Sat,<br/>june<br/>10</div>
  ...
  <button class="h-10 bg-blue-500 text-white px-4 py-2 rounded-lg flex items-center">Long texting  made easy</button>
  <button class="h-8 bg-blue-500 text-white px-4 py-2 rounded-lg flex items-center">click me</button>
  <button class="h-8 bg-blue-500 text-white px-4 py-2 rounded-lg flex items-center">click me</button>
  <button class="h-8 bg-blue-500 text-white px-4 py-2 rounded-lg flex items-center">click me</button>
</div>
  ...
  <div class="col-span-1 bg-gray-200 p-4">image {{ item }}</div>
   ...
   <!-- number of page selection -->
    <div class="flex md:ml-[150px] ml-10 ">
      <p class="text-purple-950 text-opacity-60 text-base font-medium leading-7">Show <span class="mx-2">
...
10
         ...
         <span class="text-purple-950 text-opacity-60 text-base font-medium leading-7">result per page</span></p>
    </div>
...
const data = ref([1, 2, 3, 4, 5, 6, 7, 8, 9, 23, 24, 34, 55, 67, 77, 33, 56, 78]);
